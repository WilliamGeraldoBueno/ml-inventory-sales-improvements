...
async function exportCSV(){ window.open('/api/csv', '_blank'); }
 produtos, ${result.produtos_com_necessidade} com necessidade`; loadData(); }
...
def main():
    ...
    # MODIFICAÇÃO: Importação automática de CSV na inicialização
    print("🔄 Verificando importação automática de CSV...")
    auto_import_csv()
